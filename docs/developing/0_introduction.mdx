...
<img className="block dark:hidden" src="/assets/openmind-intro-cover.png" alt="Hero Light" />
<img className="hidden dark:block" src="/assets/openmind-intro-cover.png" alt="Hero Dark"/>
