---
title: Developing with OM1
description: Get started with developing for OpenMind OS (OM1), covering core concepts like Actions, essential CLI commands, and development best practices.
---
