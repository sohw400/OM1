...
4. `zenoh_bridge` acts as a bridge between OM1 and OM1_sensor to publish and subscribe to/from ROS2 topics.
...
```
2. Open a terminal in the `unitree_sdk` directory.
...
- [Unitree G1 Documentation](https://www.unitree.com/g1)
