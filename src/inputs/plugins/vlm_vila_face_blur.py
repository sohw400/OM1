...
from providers.vlm_vila_provider_blur_face import VLMVilaProviderBlurFace
...
class VLMVilaFBLur(FuserInput[str]):
    """
    ...
    def __init__(self, config: SensorConfig = SensorConfig()):
        ...
        self.vlm: VLMVilaProviderBlurFace = VLMVilaProviderBlurFace(
