...
from providers.vlm_openai_detailed_provider import VLMOpenAIProviderDetailed
...
class VLMOpenAIDetailed(FuserInput[str]):
    """
    ...
    def __init__(self, config: SensorConfig = SensorConfig()):
        ...
        self.vlm: VLMOpenAIProvider = VLMOpenAIProviderDetailed(
    ...
    def _handle_vlm_message(self, raw_message: ChatCompletion):
        ...
        """
        logging.debug(f"VLM OpenAI received message: {raw_message}")
