...
class LocationsProvider:
    ...
    def __init__(self, list_endpoint: str = "", timeout: int = 5, refresh_interval: int = 30):
        """
    ...
    def _update_locations(self, locations_raw) -> None:
        ...
        if self.io_provider is not None:
            ...
            logging.info(f"LocationsProvider loaded {len(parsed)} locations and stored in IOProvider")
        else:
